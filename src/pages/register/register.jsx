                ...
                <div className="grid md:grid-cols-2 items-center dark:bg-slate-300 max-w-6xl w-full m-4 shadow-md rounded-lg">
                    ...
                    <div className="w-full flex flex-col justify-center md:rounded-e-lg p-5 h-full bg-slate-50 max-md:mx-auto">
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {/* title */}
                            <div className="mb-4">
                                <h3 className="text-gray-800 text-3xl !mb-2 font-bold">{t('register')}</h3>
                                <p className="text-gray-500 text-sm mt-2 leading-relaxed">{t("reg_intro")}</p>
                            </div>
                            ...
                            {errors.username && <span className="text-red-500 m-0 text-sm">{t("required")}</span>}

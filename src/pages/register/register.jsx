        ...
        <>
            ...
            <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
                <div className="grid md:grid-cols-2 items-center dark:bg-slate-300 max-w-6xl w-full m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg">
                    ...
                    <div className="w-full flex flex-col justify-center md:rounded-e-lg p-6 h-full shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>

                            {/* title */}
                            <div className="mb-4">
                                <h3 className="text-gray-800 text-3xl font-bold">{t('register')}</h3>
                                <p className="text-gray-500 text-sm mt-4 leading-relaxed">{t("reg_intro")}</p>
                            </div>
                            ...
                            >
                                <FaRegUser className="absolute end-4 w-4 h-4"
                                    fill="#bbb"
                                    stroke="#bbb"
                                />
                            </CustomField>
                            ...
                            >
                                <MdOutlineEmail
                                    className="absolute end-4 w-[18px] h-[18px]"
                                    fill="#bbb"
                                />
                            </CustomField>
                            {errors.email && <span className="text-red-500 text-sm">{t("email_valid")}</span>}
                            ...
                            >
                                {
                                    showPassword
                                        ? <AiOutlineEyeInvisible
                                            className="w-[18px] h-[18px] absolute end-4 cursor-pointer"

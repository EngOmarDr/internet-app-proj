    ...
    return (
        <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div className="grid md:grid-cols-2 items-center max-w-6xl w-full m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg">
                ...
                <div className="w-full flex flex-col justify-center rounded-b-lg md:rounded-b-none md:rounded-tr-lg md:rounded-br-lg p-6 h-full shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
                    <form className="space-y-4" onSubmit={handleRegister}>
                        ...
                        >
                            <FaRegUser className="absolute right-4 w-4 h-4"
                                fill="#bbb"
                                stroke="#bbb"
                            />
                        </CustomField>
